...
#                  attach_to, clone, and detach_from
#
#          -- Write the names of three INSTANCE VARIABLEs
#             that Circle objects have:
#                radius, center, and outline_color
#
#     f. What does a RoseWindow RENDER method do?
#            It renders the window, actually displaying it on the computer screen.
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            Whenever you want to look at the results of your program in the window. Without the close_on_mouse_click
#            it will automatically closed the window once it is finished running.
#
